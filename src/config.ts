...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/thumb-1920-1311951.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
	...
	name: "Regex520",
	bio: "Every Idea Will Turn To Project",
	links: [
		{
			name: "Email",
